                            ...
                            if ($('#sexo').val() != 'ss') {
                                if ($('#email_institucional').val() != '') {
                                    if ($('#contrasenia').val() != '') {
                                        $.ajax({
                                            type: 'POST',
                                            url: '../../control/administrador/agregar-profesor.php',
                                            data: $('#registro_profesor').serialize(),
                                            success: resultado => {
                                                if (resultado == 1) {
                                                    Swal.fire({
                                                        customClass: {
                                                        ...
                                                        icon: 'success',
                                                        title: '¡Genial!',
                                                        html: '<span class="text-white">Profesor agregado correctamente.</span>',
                                                        background: 'rgb(52, 58, 64)',
                                                        backdrop: 'rgb(52, 58, 64)'
                                                    });
                                                    $('#registro_profesor')[0].reset();
                                                    $('#boton_agregar').hide();
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        icon: 'error',
                                                        title: '¡Ups!',
                                                        html: '<span class="text-white">Ocurrio un error al agregar profesor, esto se puede deber a que ya exista.</span>',
                                                        background: 'rgb(52, 58, 64)',
                                                        backdrop: 'rgb(52, 58, 64)'
                                                    });
                                                    $('#registro_profesor')[0].reset();
