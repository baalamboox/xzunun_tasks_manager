<?php
    ...
    if(isset($_SESSION['usuario'])) {
        ...
        $sql = "SELECT nombres, apellido_paterno, foto_perfil FROM tabla_administradores WHERE email_institucional = '$usuario'";
...
?>
        ...
        <html lang="es-MX">
            <head>
                ...
                <title>
                    <?php 
                        ...
                        echo 'Administrador | ' . $nombre_completo . ucfirst($datos['apellido_paterno']);
                    ?>
                </title>
                <?php
            ...
            <body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="sidebar">
                            ...
                            <nav class="mt-2">
                                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                    ...
                                    <li class="nav-item">
                                        <a href="nuevo" class="nav-link rounded-pill" id="boton_nuevo">
                                            <i class="nav-icon fas fa-user-plus"></i>
                                            <p>Nuevo</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="carga-academica" class="nav-link rounded-pill" id="boton_carga_academica">
                                            <i class="nav-icon fas fa-grip-horizontal"></i>
                                            <p>Carga acádemica</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ciclo-escolar" class="nav-link rounded-pill" id="boton_ciclo_escolar">
                                    ...
                                    <li class="nav-item">
                                        <a href="recuperar" class="nav-link rounded-pill" id="boton_recuperar">
                ...
                <script src="../../manager/administrador/plantilla-barra-lateral.js"></script>
            </body>
        </html>
<?php
    } else {
        header('location:../../adminitrador');
    }
?>