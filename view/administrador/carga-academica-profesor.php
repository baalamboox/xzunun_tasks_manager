...
?>
<div id="vista_carga_academica_profesor">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <h3>Carga académica profesor</h3>
                        ...
                        <div class="row mt-3" id="vista_clave_materia_grupo_ciclo">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="clave">Clave:</label>
                                    <input class="form-control form-control-sm rounded-pill" id="clave" name="clave" placeholder="Ingresar clave">
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm rounded-pill" id="grupo" name="grupo">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-5" id="vista_boton_cancelar_registrar">
...
<script src="../../manager/administrador/carga-academica-profesor.js"></script>