<?php
    ...
    $sql = "SELECT contrasenia, foto_perfil FROM tabla_administradores WHERE email_institucional = '$usuario'";
...
<script src="../../manager/administrador/configuracion.js"></script>