<?php
    ...
    if(isset($_SESSION['usuario'])) {
        ...
        $sql = "SELECT nombres, apellido_paterno, foto_perfil FROM tabla_alumnos WHERE email_institucional = '$usuario'";
...
?>
        ...
        <html lang="es-MX">
            <head>
                ...
                <title>
                    <?php 
                        ...
                        echo 'Alumno | ' . $nombre_completo . ucfirst($datos['apellido_paterno']);
                    ?>
                </title>
                <?php
            ...
            <body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="sidebar">
                            ...
                            <nav class="mt-2">
                                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                    ...
                                    <li class="nav-item">
                                        <a href="archivos" class="nav-link rounded-pill" id="boton_archivos">
                ...
                <script src="../../manager/alumno/plantilla-barra-lateral.js"></script>
            </body>
        </html>
<?php
    } else {
